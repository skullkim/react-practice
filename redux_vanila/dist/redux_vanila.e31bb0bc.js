...
var btnDecrease = document.querySelector('#decrease'); //프로젝트의 상태에 변화를 일으키는 것이 액션이다.
//액션의 이름은 대문자로 작성하고 고유해야 한다.

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; //위의 액션 이름을 사용해 만든 액션 객체, 액션 객체는 반드시 type 값을 가져야 한다.
...
function reducer() {
  ...
  switch (action.type) {
    ...
    case INCREASE:
      console.log(_typeof(action.difference));
      return _objectSpread(_objectSpread({}, state), {}, {
...
var store = (0, _redux.createStore)(reducer); //상태가 업데이트 될때 마다 호출된다.
...
//# sourceMappingURL=/redux_vanila.e31bb0bc.js.map